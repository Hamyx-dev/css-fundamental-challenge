...
2. rgb(255, 0, 0) gives a fully red background meaning it gives 0% transparency and 100% solid color and also the channels are red,green and blue while rgba(255, 0, 0, 0.5) gives a 50% semi transparent and has a see through red and it also has red,green and blue but has th alpha channel which is the level of opacity for the color
